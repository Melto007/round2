        ...
        <div className='mb-2'>
            ...
            <div className='flex justify-between items-center px-6 py-2'>
                <div className='flex items-center gap-1'>
                    <p className='text-black text-xs bg-red3 px-2 py-1 font-semibold rounded-full'>{props.day}</p>
                    <p className='text-black text-xs bg-red3 px-2 py-1 font-semibold rounded-full'>{props.todo}</p>
                </div>
                <div className='flex items-center gap-1'>
                    {props.calenderIcon}
